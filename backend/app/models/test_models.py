...
# ========== PAGE 1 ==========
# 0 '\xa0'
# 1 'REACT PREMIER LEAGUE JUNE 2026 (Final)'
# 2 '8/16/26, 8:14 AM cricheroes.com 1 of 4'
# 3 'Match Details'
# 4 'Match MYTRI Heros vs'
# 5 'Red Wings'
# 6 'GroundReact Sports Cricket Ground (formerly One Champion Cricket Ground 1) AZIZ NAGAR MOINABAD,'
# 7 'Hyderabad (Telangana)'
# 8 'Date 2026-08-15, 09:44 AM UTC'
# 9 'Match Result'
# 10 'Toss MYTRI Heros opt to bat'
# 11 'Total MYTRI Heros 148/10 (18.5 Ov)'
# 12 'Red Wings 149/5 (17.3 Ov)'
# 13 'Result Red Wings won by 5 wickets'
# 14 'Best Performances - Batsmen'
# 15 'Players Name R B 4s 6s SR'
# 16 'Vardhan M 63 33 7 3 190.91'
# 17 'Rakesh 48 44 6 0 109.09'
# 18 'Deepak 39 30 6 1 130.00'
# 19 'Best Performances - Bowlers'
# 20 'Players Name O M R W Eco'
# 21 'Sai 3.5 0 11 4 2.87'
# 22 'Ch Gopi 3.0 0 27 2 9.00'
# 23 'Gnani Krishna 4.0 0 47 2 11.75'
# 24 'Match Officials'
# 25 'No Name Role Signature'
# 26 '1 Ankit Umpire'
# 27 '2 PSM Sharma Scorer'
# 28 '3 Taz Baba Live Streamer'
# 29 '4 Dileep Kumar Gosala (MYTRI Heros) Captain'
# 30 '5 Abhi (Red Wings) Captain'

# ========== PAGE 2 ==========
# 0 '\xa0'
# 1 'REACT PREMIER LEAGUE JUNE 2026 (Final)'
# 2 '8/16/26, 8:14 AM cricheroes.com 2 of 4'
# 3 'Playing Squad'
# 4 'Red Wings'
# 5 ' MYTRI Heros'
# 6 '1'
...
# 32 ' Deepak'
# 33 '10'
# 34 ' Kasi Vishwanth Reddy'
# 35 ' Harsha Molakalapalli'
# 36 '11'
# 37 ' Sandeep Reddy'
# 38 ' Surya Nalluri'
# 39 '12'
...
# 0 '\xa0'
# 1 'REACT PREMIER LEAGUE JUNE 2026 (Final)'
# 2 '8/16/26, 8:14 AM cricheroes.com 3 of 4'
# 3 'MYTRI Heros 148/10 (18.5 Ov) (1st Innings) Dileep Kumar Gosala (MYTRI Heros)'
# 4 'No Batsman Status R B M 4s 6s SR'
# 5 '1 Harsha Molakalapalli (RHB) b Rakesh 1 2 6 0 0 50.00'
# 6 '2 Gnani Krishna (RHB) lbw b Tagore 8 6 10 2 0 133.33'
# 7 '3 Dileep Kumar Gosala (c) (RHB) run out Abhi / Tagore 5 9 10 1 0 55.56'
# 8 '4 Deepak (RHB) b Abhi 39 30 29 6 1 130.00'
# 9 '5 Vardhan M (RHB) b Sai 63 33 65 7 3 190.91'
# 10 '6 Anil (LHB) c †Naveen Kumar b Sudheer Reddy18 19 18 4 0 94.74'
# 11 '7 Rajesh P (RHB) lbw b Ravi 3 5 9 0 0 60.00'
# 12 '8 Nagaraj palacharla (wk) (RHB) c Abhi b Sai 1 3 3 0 0 33.33'
# 13 '9 Venkat (RHB) b Sai 0 1 1 0 0 0.00'
# 14 '10 Surya Nalluri (RHB) not out 3 2 7 0 0 150.00'
# 15 '11 Ch Gopi (RHB) b Sai 0 4 2 0 0 0.00'
# 16 'Extras: (wd 5, nb 1, lb 1) 7'
# 17 'Total: Overs 18.5, Wickets 10 148 (CRR: 7.86)'
# 18 'To Bat: Ayyappa Mohan'
# 19 'Fall of Wickets'
# 20 '10-1 (Harsha Molakalapalli, 1.1 ov), 14-2 (Gnani Krishna, 2.1 ov), 22-3 (Dileep Kumar Gosala, 4.1 ov), 76-4 (Deepak, 9.3 ov), 109-5 (Anil, 13.3 ov), 136-6 (Rajesh P,'
# 21 '15.5 ov), 139-7 (Nagaraj palacharla, 16.4 ov), 139-8 (Venkat, 16.5 ov), 148-9 (Vardhan M, 18.1 ov), 148-10 (Ch Gopi, 18.5 ov)'
# 22 'No Bowler O M R W 0s 4s 6s WD NB Eco'
# 23 '1 Tagore 3 0 26 1 10 4 1 0 0 8.67'
# 24 '2 Rakesh 2 0 11 1 8 2 0 1 0 5.50'
# 25 '3 Sai 3.5 0 11 4 16 1 0 0 0 2.87'
# 26 '4 Kasi Vishwanth Reddy 2 0 24 0 3 3 1 1 0 12.00'
# 27 '5 Ravi 2 0 22 1 4 4 0 0 0 11.00'
# 28 '6 Abhi (c) 1 0 17 1 2 1 2 0 0 17.00'
# 29 '7 JD 3 1 16 0 12 2 0 2 1 5.33'
# 30 '8 Sudheer Reddy 2 0 20 1 3 3 0 1 0 10.00'

# ========== PAGE 4 ==========
# 0 '\xa0'
# 1 'REACT PREMIER LEAGUE JUNE 2026 (Final)'
# 2 '8/16/26, 8:14 AM cricheroes.com 4 of 4'
# 3 'Red Wings 149/5 (17.3 Ov) (1st Innings) Abhi (Red Wings)'
# 4 'No Batsman Status R B M 4s 6s SR'
# 5 '1 Naveen Kumar (wk) (RHB) c Anil b Gnani Krishna 31 15 22 4 1 206.67'
# 6 '2 Ravi (RHB) c Anil b Ch Gopi 7 10 13 1 0 70.00'
# 7 '3 Rakesh (RHB) b Gnani Krishna 48 44 48 6 0 109.09'
# 8 '4 JD (RHB) c Anil b Ch Gopi 23 14 23 3 1 164.29'
# 9 '5 Rahul Abraham N (RHB) run out † Nagaraj palacharla 1 1 4 0 0 100.00'
# 10 '6 Tagore (LHB) not out 9 11 21 0 0 81.82'
# 11 '7 Abhi (c) (RHB) not out 17 11 10 2 1 154.55'
# 12 'Extras: (lb 2, wd 10, nb 1) 13'
# 13 'Total: Overs 17.3, Wickets 5 149 (CRR: 8.51)'
# 14 'To Bat: Sai, Sandeep Reddy, Spanil, Sudheer Reddy, Kasi Vishwanth Reddy'
# 15 'Fall of Wickets'
# 16 '35-1 (Ravi, 3.3 ov), 60-2 (Naveen Kumar, 5.4 ov), 102-3 (JD, 11.3 ov), 105-4 (Rahul Abraham N, 12.1 ov), 126-5 (Rakesh, 15 ov)'
# 17 'No Bowler O M R W 0s 4s 6s WD NB Eco'
# 18 '1 Ch Gopi 3 0 27 2 8 5 0 1 0 9.00'
# 19 '2 Anil 3 0 22 0 8 1 1 0 0 7.33'
# 20 '3 Gnani Krishna 4 0 47 2 9 6 2 1 1 11.75'
# 21 '4 Surya Nalluri 2 0 19 0 4 3 0 2 0 9.50'
# 22 '5 Deepak 3 0 16 0 5 1 0 0 0 5.33'
# 23 '6 Rajesh P 2.3 0 16 0 4 1 0 2 0 6.40'